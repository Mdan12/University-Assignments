...
public class Graph {
    ...
    public void addEdge(int v, int w) {
        ...
        validateVertex(w);
        if (v == w){
            throw new IllegalArgumentException("You're trying to connect " + v + " to itself");
        }
        for (int neighbor: adj(v)) {
            if (neighbor == w) {
                throw new IllegalArgumentException(v + " is already connected to " + w);
            }
        }
        E++;
        adj[v].add(w);
